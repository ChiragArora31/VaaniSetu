...
class WhisperTranscriber:
    ...
    def _transcribe_once(
        ...
        segments_iter, info = model.transcribe(
            ...
            task="transcribe",
            # Whisper treats this as prior transcript text, not an instruction.
            # Natural-language instructions can be echoed during quiet media and
            # become a false transcript, so BAIF jobs rely on the explicit
