...
# Hosted translation is intentionally not a configurable runtime route. Normal
# BAIF content must remain on the configured worker.
ENABLE_HOSTED_TRANSLATION = False
