...
3. Use **Record**, **Text**, or **Upload**. Selecting audio/video opens the output package and preselects target-language voice; video also preselects captioned and translated-audio MP4 outputs. You may deselect an output deliberately before processing.
